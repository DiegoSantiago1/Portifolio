            ...
            <article class="project-card reveal delay-${Math.min((index + 1) * 100, 400)} rounded-xl overflow-hidden shadow-lg flex flex-col transform transition-all duration-500 ease-in-out hover:scale-[1.02]" data-tags="${escapeHtml(project.category)}">
                <div class="project-card-container h-full flex flex-col">
                    ...
                    <div class="p-4 md:p-5 pb-6 md:pb-10 flex-grow flex flex-col bg-inherit border-x-2 border-b-2 border-gray-300 dark:border-gray-600 rounded-b-xl">
                        ...
                        ${project.link
                            ? `<a href="${escapeHtml(project.link)}" target="_blank" rel="noopener noreferrer" class="project-button w-full text-sm"><span>Abrir projeto</span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path><polyline points="15 3 21 3 21 9"></polyline><line x1="10" y1="14" x2="21" y2="3"></line></svg></a>${project.repo ? `<a href="${escapeHtml(project.repo)}" target="_blank" rel="noopener noreferrer" class="mt-3 text-center text-xs md:text-sm text-gray-600 dark:text-gray-400 hover:text-orange-500 dark:hover:text-orange-400 underline underline-offset-4 transition-colors">Ver código no GitHub</a>` : ''}`
